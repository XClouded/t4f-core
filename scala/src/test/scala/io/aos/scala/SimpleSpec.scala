...
/**
 * <p>
 * Sample specification: This specification can be executed with: scala -cp <your classpath=""> ${package}.SpecsTest
...
class SimpleSpec extends Specification with JUnit /*with ScalaCheck*/ {
