 ...
 */
package io.aos.bval.service;

import io.aos.bval.annotation.Insert;
import io.aos.bval.annotation.Update;
...
@Singleton
public class DummyCountryService {
    ...
    public Country insertCountry(@NotNull(
            groups = {
                Insert.class
            }) String name, @NotNull(
            groups = {
