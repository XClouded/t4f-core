...
public class CollectionTest extends BaseTest {
    ...
    /**
     * The <code>ModVector</code> class implements a growable array of objects.
     * Like an array, it contains components that can be accessed using an
     * integer index. However, the size of a <code>ModVector</code> can grow or
     * shrink as needed to accommodate adding and removing items after the
     * <code>ModVector</code> has been created.
     * <p>
     * 
     * Each vector tries to optimize storage management by maintaining a
     * <code>capacity</code> and a <code>capacityIncrement</code>. The
     * <code>capacity</code> is always at least as large as the vector size; it
     * is usually larger because as components are added to the vector, the
     * vector's storage increases in chunks the size of
     * <code>capacityIncrement</code>. An application can increase the capacity
     * of a vector before inserting a large number of components; this reduces
     ...
     * Unlike the new collection implementations, ModVector is synchronized.
     * <p>
     * 
     * The Iterators returned by ModVector's iterator and listIterator methods
     * are <em>fail-fast</em>: if the ModVector is structurally modified at any
     * time after the Iterator is created, in any way except through the
     * Iterator's own remove or add methods, the Iterator will throw a
     * ConcurrentModificationException. Thus, in the face of concurrent
     * modification, the Iterator fails quickly and cleanly, rather than risking
     * arbitrary, non-deterministic behavior at an undetermined time in the
     * future. The Enumerations returned by ModVector's elements method are
     * <em>not</em> fail-fast.
     * 
     * <p>
     ...
     * @since JDK1.0
     */
    public static class ModVector<E> extends AbstractList<E> implements
         ...
         * <p>
         * 
         * Any array elements following the last element in the ModVector are
         * null.
         * 
         * @serial
         */
         ...
         * size is still smaller than <tt>minCapacity</tt>, then the new
         ...
         * Synchronized methods in this class can internally call this method
         * for ensuring capacity without incurring the cost of an extra
         * synchronization.
         * 
         ...
         * current size, new <code>null</code> items are added to the end of the
         * vector. If the new size is less than the current size, all components
         * at index <code>newSize</code> and greater are discarded.
         * 
         * @param newSize
         ...
         *         kept in the field <tt>elementData</tt> of this vector).
         */
        public int capacity() {
         ...
         * <tt>Enumeration</tt> object will generate all items in this vector.
         * The first item generated is the item at index <tt>0</tt>, then the
         * item at index <tt>1</tt>, and so on.
         * 
         ...
         *         same as a component in this vector, as determined by the
         ...
         * @return the index of the last occurrence of the specified object in
         *         this vector at position less than or equal to
         *         <code>index</code> in the vector, that is, the largest value
         *         <tt>k</tt> such that
         *         <tt>elem.equals(elementData[k]) && (k &lt;= index)</tt> is
         *         <tt>true</tt>; <code>-1</code> if the object is not found.
         *         (Returns <code>-1</code> if <tt>index</tt> is negative.)
         * @exception IndexOutOfBoundsException
         *                if <tt>index</tt> is greater than or equal to the
         ...
         *                current size of this <tt>ModVector</tt> object. given.
         * @see #get(int)
         * @see List
         */
         ...
         * part of the List interface). Note that the set method reverses the
         * order of the parameters, to more closely match array usage. Note also
         * that the set method returns the old value that was stored at the
         * specified position.
         * 
         * @param obj
         ...
         * is part of the List interface). Note that the remove method returns
         ...
         * specified <code>index</code>. Each component in this vector with an
         * index greater or equal to the specified <code>index</code> is shifted
         * upward to have an index one greater than the value it had previously.
         * <p>
         * 
         * The index must be a value greater than or equal to <code>0</code> and
         * less than or equal to the current size of the vector. (If the index
         * is equal to the current size of the vector, the new element is
         * appended to the ModVector.)
         * <p>
         * 
         * This method is identical in functionality to the add(Object, int)
         * method (which is part of the List interface). Note that the add
         * method reverses the order of the parameters, to more closely match
         * array usage.
         * 
         * @param obj
         ...
         * <p>
         * 
         * This method is identical in functionality to the clear method (which
         ...
         * internal data array of this <tt>ModVector</tt> object.
         * 
        ...
        /**
         * Returns an array containing all of the elements in this ModVector in
         * the correct order.
         * 
         * @since 1.2
         */
         ...
         * the specified array. If the ModVector fits in the specified array, it
         * is returned therein. Otherwise, a new array is allocated with the
         * runtime type of the specified array and the size of this ModVector.
         * <p>
         * 
         * If the ModVector fits in the specified array with room to spare
         * (i.e., the array has more elements than the ModVector), the element
         * in the array immediately following the end of the ModVector is set to
         * null. This is useful in determining the length of the ModVector
         * <em>only</em> if the caller knows that the ModVector does not contain
         * any null elements.
         * 
         * @param a
         *            the array into which the elements of the ModVector are to
         ...
         *                the runtime type of a is not a supertype of the
         *                runtime type of every element in this ModVector.
         * @throws NullPointerException
         *             if the given array is null.
         * @since 1.2
         */
        ...
        /**
         * Replaces the element at the specified position in this ModVector with
         ...
         * 
         * @param o
         *            element to be appended to this ModVector.
         ...
         * ModVector If the ModVector does not contain the element, it is
         * unchanged. More formally, removes the element with the lowest index i
         * such that <code>(o==null ? get(i)==null : o.equals(get(i)))</code>
         * (if such an element exists).
         * 
         * @param o
         *            element to be removed from this ModVector, if present.
         ...
         * ModVector. Shifts the element currently at that position (if any) and
         ...
         * if the specified Collection is this ModVector, and this ModVector is
         * nonempty.)
         * 
         * @param c
         *            elements to be inserted into this ModVector.
         * @return <tt>true</tt> if this ModVector changed as a result of the
         *         call.
         * @throws NullPointerException
         *             if the specified collection is null.
         * @since 1.2
        ...
        /**
         * Removes from this ModVector all of its elements that are contained in
         * the specified Collection.
         * 
         * @param c
         *            a collection of elements to be removed from the ModVector
         ...
         * 
         * @param c
         *            a collection of elements to be retained in this ModVector
         ...
         * (increases their indices). The new elements will appear in the
         * ModVector in the order that they are returned by the specified
        ...
        /**
         * Compares the specified Object with this ModVector for equality.
        ...
        /**
         * Returns a string representation of this ModVector, containing the
         ...
         * this List, so changes in the returned List are reflected in this
         ...
         * </pre>
         * 
         * Similar idioms may be constructed for indexOf and lastIndexOf, and
         ...
         * are those that change the size of the List, or otherwise perturb it
         ...
         * ArrayList by (toIndex - fromIndex) elements. (If toIndex==fromIndex,
