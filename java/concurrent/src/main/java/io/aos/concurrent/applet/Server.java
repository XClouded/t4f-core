    ...
    public void run() {
        try {
            while (true) {
                ...
                Connection c = new Connection(client_socket, threadgroup, 3, vulture);
...
class Connection extends Thread {
    ...
    public Connection(Socket client_socket, ThreadGroup threadgroup, int priority, Vulture vulture) {
