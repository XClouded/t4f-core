...
public class AlternateDeadlockDetectingLock extends ReentrantLock {
    ...
    private static
             boolean canThreadWaitOnLock0(Thread t, AlternateDeadlockDetectingLock l) {
    ...
    private static synchronized
             boolean canThreadWaitOnLock(Thread t, AlternateDeadlockDetectingLock l) {
    ...
    //    FastFail: if set true, deadlock exception will thrown for every call after
