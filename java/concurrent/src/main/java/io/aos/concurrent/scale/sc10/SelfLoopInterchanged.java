 ...
 * under the License.                                           *
 ****************************************************************/
package io.aos.concurrent.scale.sc10;
...
public class SelfLoopInterchanged implements ScaleTester {
    ...
    private class SelfLoopInterchangedHandler
                                    extends SelfLoopHandler {
        SelfLoopInterchangedHandler(int nc, int nt) {
            super(0, nc, 10, nt);
        }
    ...
    public float[][] doCalc() {
        SelfLoopInterchangedHandler loop =
                    new SelfLoopInterchangedHandler(nCols, nThreads);
        loop.loopProcess();
        return lookupValues;
    }
}
