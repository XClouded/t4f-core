	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if ( subject.hasRole("admin") ) {
				...
				System.out.println(subject.getPrincipal() + " has admin role");
				
			} else {
				
				System.out.println(subject.getPrincipal() +  " doesn't have admin role");
				
			}
			
			if (subject.hasRole("user")) {
				
				System.out.println(subject.getPrincipal() + " has user role");
				
			} else {
				
				System.out.println(subject.getPrincipal() + " doesn't have user role");
			}
			
			if (subject.hasRole("staff")) {
				
				System.out.println(subject.getPrincipal() + " has staff role");
				
			} else {
				
				System.out.println(subject.getPrincipal() + " doesn't have staff role");
			}
