...
public class BeforeAdviceMethodInvocationAdapter implements MethodInvocation {
     ...
     * {@link BeforeAdviceMethodInvocationAdapter} instance using the AspectJ
     * {@link JoinPoint} provided. The the joint point passed in is not a method
     * joint point, this method throws an {@link IllegalArgumentException}.
     * 
     * @param aJoinPoint
     *            The AspectJ {@link JoinPoint} to use to adapt the advice.
     * @return The created instance.
     * @throws IllegalArgumentException
     *             If the join point passed in does not involve a method call.
     */
    public static BeforeAdviceMethodInvocationAdapter createFrom(
        ...
        if (aJoinPoint.getSignature() instanceof MethodSignature) {
            ...
            throw new IllegalArgumentException(
                    "The joint point signature is invalid: expected a MethodSignature or an AdviceSignature but was "
                            + aJoinPoint.getSignature());
        }
    }
     ...
     */
    public BeforeAdviceMethodInvocationAdapter(Method aMethod,
