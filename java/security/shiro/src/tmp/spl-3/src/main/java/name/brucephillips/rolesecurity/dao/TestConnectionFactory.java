...
public class TestConnectionFactory {
  ...
  public static void main(String... args) {
    ...
    try {
      ...
      psc.execute();
      psc.close();
      sql = "INSERT INTO ROLES_PERMISSIONS (ROLE_NAME, PERMISSION) VALUES ('admin', 'perm1')";
      psc = aConnection.prepareStatement(sql);
      psc.execute();
      psc.close();      
      sql = "INSERT INTO ROLES_PERMISSIONS (ROLE_NAME, PERMISSION) VALUES ('admin', 'perm2')";
      psc = aConnection.prepareStatement(sql);
      psc.execute();
      psc.close();      
      sql = "INSERT INTO ROLES_PERMISSIONS (ROLE_NAME, PERMISSION) VALUES ('user', 'perm2')";
      psc = aConnection.prepareStatement(sql);
      psc.execute();
      psc.close();      
