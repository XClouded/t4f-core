var XWiki = (function (XWiki) {
  ...
  function init(){
    var sources = [
        ...
        name : "Document name",
        varname : 'input',
        script : "/get/XWiki/SuggestLuceneService?outputSyntax=plain&query=name:__INPUT__* OR web:__INPUT__*&nb=3&",
        icon : "/resources/icons/silk/page_white_text.png",
        highlight:  true       },
                      {
        name : "Document content",
        varname : 'input',
        script : "/get/XWiki/SuggestLuceneService?outputSyntax=plain&query=__INPUT__*&nb=3&",
        icon : "/resources/icons/silk/page_white_text.png",
        highlight:  false       },
                      {
        name : "Attachment name",
        varname : 'input',
        script : "/get/XWiki/SuggestLuceneService?outputSyntax=plain&query=name:__INPUT__* AND type:attachment&nb=3&",
        icon : "/resources/icons/silk/attach.png",
        highlight:  true       },
                      {
        name : "Attachment content",
        varname : 'input',
        script : "/get/XWiki/SuggestLuceneService?outputSyntax=plain&query=__INPUT__* AND type:attachment&nb=3&",
        icon : "/resources/icons/silk/attach.png",
        highlight:  false       },
                      {
        name : "Blog Posts",
        varname : 'input',
        script : "/get/XWiki/SuggestLuceneService?outputSyntax=plain&query=__INPUT__* AND object:Blog.BlogPostClass&nb=3&",
        icon : "/resources/icons/silk/page_white_picture.png",
        highlight:  false       },
