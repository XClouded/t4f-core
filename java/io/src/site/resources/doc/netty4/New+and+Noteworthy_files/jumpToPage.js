...
}}else{a.JumpToPage=Class.create(a.ModalPopup,{urlTemplate:"/__action__/__space__/__document__",initialize:function($super){var e=new Element("div");
...
$super(d);
if(typeof(c.widgets.Suggest)!="undefined"){new c.widgets.Suggest(this.input,{script:"/rest/wikis/xwiki/search?scope=name&number=10&",varname:"q",noresults:"No documents found",icon:"/resources/icons/silk/page_white_text.png",json:true,resultsParameter:"searchResults",resultId:"id",resultValue:"pageFullName",resultInfo:"pageFullName",timeout:30000,parentContainer:this.dialog})
