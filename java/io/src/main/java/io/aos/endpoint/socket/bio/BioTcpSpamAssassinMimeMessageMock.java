...
public class BioTcpSpamAssassinMimeMessageMock extends MimeMessage {
    ...
    public BioTcpSpamAssassinMimeMessageMock() throws MessagingException {
        super((Session)null);
    }

    public BioTcpSpamAssassinMimeMessageMock(int messageNumber) throws MessagingException {
        super((Session)null);
        m_iMessageNumber = messageNumber;
    }

    public BioTcpSpamAssassinMimeMessageMock(MimeMessage mimeMessage) throws MessagingException {
    ...
    public Message reply(boolean b) throws MessagingException {
        return new BioTcpSpamAssassinMimeMessageMock(this); // trivial implementation
    }
    ...
    protected InternetHeaders createInternetHeaders(InputStream inputStreamputStream) throws MessagingException {
