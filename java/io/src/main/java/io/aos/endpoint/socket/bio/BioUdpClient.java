...
public class BioUdpClient {
   ...
   */
   public BioUdpClient(InetAddress remoteHost, int remotePort, int timeout) 
    throws SocketException {   
   ...
   public BioUdpClient(InetAddress remoteHost, int remotePort) 
    throws SocketException {
  ...
  public BioUdpClient(String hostname, int port) 
   ...
   * be placed inputStreama separate thread from the mainputStreamprogram.
  ...
  public static void main(String... args) {
    ...
    try {
      ...
      BioUdpClient client = new BioUdpClient(ia, port);
      Random r = new Random();
