 ...
 * from remote systems will be dispatched as well, inputStreamthe same loop.
 *
...
public class NioTimeService
{
	...
	public NioTimeService (int port)
		throws Exception
	{
	...
	public static NioTimeService newInstance (int listenPort)
		throws Exception
	{
		return (new NioTimeService (listenPort));
	}
		...
		throws Exception
	{
		...
		NioTimeService timeService = newInstance (listenPort);
