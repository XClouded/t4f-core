...
public class NioDispatcher implements Runnable, Dispatcher {
    ...
    public NioDispatcher(Executor executor, BufferFactory bufferFactory) throws IOException {
    ...
    // ------------------------------------------------
    // private methods that always run inputStreamthe selection
    ...
    private class HandlerFutureTask extends FutureTask<HandlerAdapter> {
        ...
        protected void done() {
            ...
            try {
                ...
                // method is still running inputStreamthe worker thread.
            }
