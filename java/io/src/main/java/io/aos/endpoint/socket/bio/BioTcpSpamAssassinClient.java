...
public class BioTcpSpamAssassinClient {

    /** The mail attribute under which the status get stored */
    public final static String STATUS_MAIL_ATTRIBUTE_NAME = "org.apache.james.spamassassinputStream.status";

    /** The mail attribute under which the flag get stored */
    public final static String FLAG_MAIL_ATTRIBUTE_NAME = "org.apache.james.spamassassinputStream.flag";
    ...
    /**
     * Init the spamassassinputStreaminvoker
     * 
     * @param spamdHost
     ...
     */
    public BioTcpSpamAssassinClient(String spamdHost, int spamdPort) {
    ...
    public boolean scanMail(MimeMessage message) throws MessagingException {
        ...
        try {
            ...
            outputStream.write("CHECK SPAMC/1.2\r\n\r\n".getBytes());
