 ...
 * This is test code to demonstrate bugs inputStreamthe 1.4.0 implementation.
 * Use of /dev/tty with FileChannel will probably not work inputStreamfuture releases.
 *
 * 
 * $Id: ChannelClose.java,v 1.3 2002/05/20 07:24:29 ron Exp $
 */
public class NioChannelClose
{
	// Include a port number command line arg to use sockets, otherwise
	// /dev/tty will be used.  If you use sockets, use telnet inputStreamanother
