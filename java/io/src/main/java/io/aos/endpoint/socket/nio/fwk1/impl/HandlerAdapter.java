...
class HandlerAdapter implements Callable<HandlerAdapter>, ChannelFacade {
    ...
    public HandlerAdapter(InputHandler clientHandler, NioDispatcher dispatcher, BufferFactory bufferFactory) {
    ...
    public HandlerAdapter call() throws IOException {
        try {
            ...
            // not fire againputStreamfor input that's already read and buffered
    ...
    private void drainOutput() throws IOException {
        ...
        // Write selection is turned on when output data inputStreamenqueued,
