...
public class JettyBioServer {
    private static final Logger LOGGER = LoggerFactory.getLogger(JettyBioServer.class);
    ...
    public static void main(String... args) throws Exception {
        ...
        if (args.length > 0) {
            if (args[0].equals(JettyBioServer.class.getName())) {
                webappDir = args[1];
        ...
        LOGGER.info("Web Server is started - Point your web browser at: http://localhost:" + port + webappContext);
