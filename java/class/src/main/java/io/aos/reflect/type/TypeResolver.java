...
public final class TypeResolver {
     ...
     * {@code targetType} resolved upwards from the {@code initialType}. If no
     ...
     * @return type argument for {@code initialType} else {@code null} if no
    ...
    /**
     * Resolves the type argument for the {@code genericType} using type
     * variable information from the {@code sourceType}. If {@code genericType}
     * is an instance of class, then {@code genericType} is returned. If no
     * arguments can be resolved then {@code Unknown.class} is returned.
     * 
     * @param genericType
     *            to resolve upwards from
     ...
     * {@code targetType} resolved upwards from the {@code initialType}.
     * Arguments for {@code targetType} that cannot be resolved to a Class are
     * returned as {@code Unknown.class}. If no arguments can be resolved then
     ...
     * @param targetType
     *            to resolve arguments for
     * @return array of raw classes representing type arguments for
    ...
    /**
     * Resolves the arguments for the {@code genericType} using the type
     * variable information for the {@code targetType}. Returns {@code null} if
    ...
    /**
     * Resolves the generic Type for the {@code targetType} by walking the type
     * hierarchy upwards from the {@code initialType}.
     */
    ...
    /**
     * Resolves the raw class for the given {@code genericType}, using the type
     * variable information from the {@code targetType}.
     */
