package io.aos.game.spaceinvaders.sp1;
...
public class Game {
    ...
    private boolean setDisplayMode() {
        try {
            ...
            org.lwjgl.util.Display.setDisplayMode(dm, new String[] { "width=" + width, "height=" + height,
                    "freq=" + 60, "bpp=" + org.lwjgl.opengl.Display.getDisplayMode().getBitsPerPixel() });
            return true;
        }
        catch (Exception e) {
            e.printStackTrace();
