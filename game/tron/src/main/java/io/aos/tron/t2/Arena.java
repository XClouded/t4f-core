...
public class Arena extends Canvas implements Runnable {
     ...
     * start()
     * 
     * this method is called once, when the arena is initialized and its
     ...
     * and selects a robot controller
     * 
     */
    public void selectPlayer1(int player, String filename) {
        if (player == Tron.GP) {
     ...
     * startPlayers()
     * 
     * this method is called when the user clicks on the "start" button in the
     * interface
     * 
     */
     ...
     * run()
     * 
     * this is the "run" method that executes forever while the runnable thread
     * is executing
     * 
     */
    public void run() {
     ...
     * update()
     * 
     * this method is called by the native paint() method to draw on this canvas
     * 
     */
