...
public class Game implements Runnable {
    ...
    public void run() {
        ...
        topMenu.add(play);
        final JButton instructions = new JButton(new ImageIcon("instructions_before.png"));
        topMenu.add(instructions);
        final JButton quit = new JButton(new ImageIcon("quit_before.png"));
        topMenu.add(quit);
        ...
        // the story level
        final TronMapStory levelStory = new TronMapStory(scoreStory1, scoreStory2, 2);
        ...
        instructions.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if (instructOn) {
                    ...
                    mainMenu.add(pict);
                    instructions.setIcon(new ImageIcon("instructions_before.png"));
                }
                else if (!instructOn) {
