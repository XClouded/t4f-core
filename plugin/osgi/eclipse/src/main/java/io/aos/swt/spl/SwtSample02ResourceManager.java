 ...
 * #SWTResourceManager:version3.0.0#
 */
public class SwtSample02ResourceManager {

	private static HashMap resources = new HashMap();
	private static Vector users = new Vector();
	private static SwtSample02ResourceManager instance = new SwtSample02ResourceManager();
